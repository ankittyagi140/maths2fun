    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-black text-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center pt-20 pb-20">
          <h1 className="text-4xl md:text-5xl font-bold text-center mb-2 text-[#FFE66D] font-['Comic_Sans_MS'] animate__animated animate__fadeIn">Transform Your Math Skills</h1>
          <p className="text-xl text-white mb-12 font-['Nunito'] max-w-2xl mx-auto">Master mathematics through interactive learning and gamified challenges</p>
          <Link 
            href="/signup" 
...
function TestimonialCard({ quote, author }: { 
  ...
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg">
      ...
      <p className="text-gray-600 mb-4 italic">&ldquo;{quote}&ldquo;</p>
