...
import { PatternRecognitionMatchingPuzzles } from "@/lib/pattern-recognition-matching-puzzles";

const PatternRecognition:React.FC=()=>{

    const patternRecognitaionPuzzles:PuzzlesCards[] = PatternRecognitionMatchingPuzzles;


    return (<section id="featured-puzzles" className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-black mb-4 animate__animated animate__fadeInDown">Pattern Recognition & Matching Puzzles</h2>
    ...
    {
        patternRecognitaionPuzzles.map((game) => {
