...
import { TimeBasedMultiplayerPuzzles } from "@/lib/time-based-multiplayer-puzzles";

const TimeBasedMultiplayer:React.FC=()=>{

    const timeBasedMultiplayerPuzzles:PuzzlesCards[] = TimeBasedMultiplayerPuzzles;


    return (<section id="featured-puzzles" className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-black mb-4 animate__animated animate__fadeInDown">Time-Based & Multiplayer Puzzles</h2>
    ...
    {
        timeBasedMultiplayerPuzzles.map((game) => {
...
export default TimeBasedMultiplayer;